...
#define RF_STATUS               0x07    // The "main" register shifted out every time (IRQ trigger sources)
...
void NRF24_pin_config(s_nRF24L01 *dev, SPI_HandleTypeDef *SPIx, GPIO_TypeDef *cs_port, uint16_t cs_pin, GPIO_TypeDef *ce_port, uint16_t ce_pin);
